...
$$
\mathcal{L}_{structure} = \mathcal{L}_{edge} + \mathcal{L}_{GAN}
$$
...
$$
F_{out} = \alpha \cdot F_{in} + \gamma + \text{Residual}
$$

损失函数为重建损失加上感知损失：

$$
\mathcal{L}_{enhancement} = \mathcal{L}_{reconstruction} + \mathcal{L}_{perceptual}
$$
